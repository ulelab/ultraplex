...
python3 ultraplex.py -i tests/test_simple/reads1.fastq.gz -i2 tests/test_simple/reads2.fastq.gz -b tests/test_simple/barcodes_different_umis.csv -d tests/test_simple/umi_lengths -o umi_lengths
